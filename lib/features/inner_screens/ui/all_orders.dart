...
import 'package:smartshop/features/inner_screens/ui/widgets/all_orders_list_view_item.dart';
    ...
    return isEmpty
        ...
        : Scaffold(
          appBar: AppBar(
            ...
            title: const AppBarTitle(title: 'Placed Orders', fontSize: 25),
            actions: [
              IconButton(
                onPressed: () {},
          ...
          body: ListView.separated(
            ...
            itemBuilder:
                (context, index) => AllOrdersListViewItem(
